...
folder_path = './output/DoubleDuelingDQN/'
# folder_path = './'
final_weights = './output/DoubleDuelingDQN/final_weights.h5'
...
if args.mode == 'train' and False:
    ...
    try:
        with open('./output/DoubleDuelingDQN/dqn_history', 'wb') as file:
